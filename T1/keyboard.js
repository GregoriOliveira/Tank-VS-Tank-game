...
function keyboardUpdate() {
  ...
  // Tank 1 movement
  if (keyboard.pressed("W")) tank1.translateZ(0.3);
  if (keyboard.pressed("S")) tank1.translateZ(-0.3);
  ...
  // Tank 2 movement
  if (keyboard.pressed("up")) tank2.translateZ(0.3);
  if (keyboard.pressed("down")) tank2.translateZ(-0.3);
